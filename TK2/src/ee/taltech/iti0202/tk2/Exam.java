...
public class Exam {
    public static final int BLACKJACK_SCORE_TO_ACHIEVE = 21;
    ...
    public static int blackjack(int a, int b) {
        if (a > BLACKJACK_SCORE_TO_ACHIEVE && b <= BLACKJACK_SCORE_TO_ACHIEVE) {
            return b;
        } else if (b > BLACKJACK_SCORE_TO_ACHIEVE && a <= BLACKJACK_SCORE_TO_ACHIEVE) {
            return a;
        } else if (b > BLACKJACK_SCORE_TO_ACHIEVE) {
            return 0;
        } else if (b > a) {
            return b;
        }
    ...
    public static String repeatEnd(String str, int n) {
        String stringToBeAdded = str.substring(str.length() - n, str.length());
        StringBuilder newString = new StringBuilder();
        for (int i = 0; i < n; i++) {
            newString.append(stringToBeAdded);
        }
